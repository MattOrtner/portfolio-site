...
const Projects = () => {
  return (
    <div className="bg-gray-200 flex justify-center items-center">
      <div className="m-4 flex-col gap-2 max-w-[1400px] max-[400px]:h-full">
        <NavBar />
        <div className="m-10 flex gap-4 max-[400px]:grid max-[400px]:m-3 max-[400px]:gap-2">
          ...
          <a
            ...
            // className="flex gap-4 max-[400px]:grid max-[400px]:m-3 max-[400px]:gap-2"
          >
            <Image
              src={EtsyScreenShot}
